...
* **Security & Compliance:** Cryptographic Sanitization, RBAC, HIPAA/NDPR Enterprise Deployment.
...
## 🏛️ Enterprise Deployments (Proof of Concept)

### 🔬 Clinical Data Infrastructure (UMTH) 
**Lead Clinical Systems Administrator**
Engineered a highly resilient REDCap v16.0.6 EDC deployment for the University of Maiduguri Teaching Hospital. Migrated critical infectious disease diagnostics to a secure, local-first server architecture, ensuring 99.9% uptime during regional network blackouts.

### 🏛️ Secure State HR Infrastructure (KIUTH)
