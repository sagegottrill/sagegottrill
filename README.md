...
* **Engineering:** React, TypeScript, Node.js, PostgreSQL, GraphQL.
* **Geospatial & Edge:** PostGIS, Edge AI (TinyML), LoRaWAN Mesh, IoT Telemetry.
* **Enterprise Health:** REDCap (v16.0.6 Enterprise Super Admin), LIMS, HIPAA/NDPR Data Compliance.
* **DevOps:** CI/CD, Docker, Low-Bandwidth Linux Server Hardening.
